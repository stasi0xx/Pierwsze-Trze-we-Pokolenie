...
const containerVariants: Variants = {
    ...
    visible: {
        opacity: 1,
        transition: {
            staggerChildren: 0.2, // Opóźnienie między pojawianiem się kolejnych dzieci
            delayChildren: 0.1
        }
    }
};

// Warianty animacji dla pojedynczego elementu (wejście od dołu)
...
// Komponent TeamMember (pozostawiony, jeśli chciałbyś go użyć w przyszłości)
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="mb-24">
                    ...
                    <motion.h3
                        ...
                        viewport={{ once: true }}
                        className="text-3xl font-display font-bold mb-10 border-l-4 border-neon-yellow pl-6"
                    >
                        Lider i Mentor
                    </motion.h3>

                    <div className="flex flex-col lg:flex-row gap-12 items-start">
                        {/* Image Section - wjazd od lewej */}
                        <motion.div
                        ...
                        {/* Content Section - Kaskadowe pojawianie się elementów */}
                        <motion.div
                        ...
                        >
                            ...
                            <motion.div // @ts-ignore
                                ...
                                <p className="text-gray-300 text-lg leading-relaxed">
                                    <span className="text-neon-yellow">Mąż</span> i <span className="text-neon-yellow">ojciec</span> trójki <span className="text-neon-yellow">dzieci</span> (w tym dwojga licealistów), który łączy życie rodzinne z biznesem na najwyższym poziomie. Współzałożyciel <a href={"https://omida.pl/"} target={"_blank"} rel="noreferrer"><span className="text-white font-semibold hover:text-neon-yellow transition-colors cursor-pointer">Omida Group</span></a> – spółki logistycznej z przychodami przekraczającymi <span className="text-neon-yellow">1 mld PLN</span>.
                                </p>
                            </motion.div>

                            <motion.div
                                variants={itemVariants} className="grid sm:grid-cols-2 gap-5">
                                <div className="p-6 rounded-2xl bg-white/5 border border-white/10 hover:border-neon-yellow/30 transition-all hover:bg-white/10 group interactive">
                                    <div className="flex items-center gap-2 mb-3">
                                        <Award className="text-neon-yellow group-hover:scale-110 transition-transform" size={20}/>
                                ...
                                <div className="p-6 rounded-2xl bg-white/5 border border-white/10 hover:border-neon-yellow/30 transition-all hover:bg-white/10 group interactive">
                                    <div className="flex items-center gap-2 mb-3">
                                        <Activity className="text-neon-yellow group-hover:scale-110 transition-transform" size={20}/>
                            ...
                            <motion.div
                                variants={itemVariants} className="relative pl-8 border-l-2 border-neon-yellow/50 py-2">
