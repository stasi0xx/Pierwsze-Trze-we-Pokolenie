...
export const Navbar: React.FC = () => {
  ...
  const navLinks = [
    ...
    { name: 'Ambasadorzy', href: '/ambasadorzy' },
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 ${isScrolled ? 'py-2 glass-panel border-b border-glass-border' : 'py-0 bg-transparent'
        }`}
    >
